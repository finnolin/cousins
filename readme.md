...
| ------------------------ | --------- | ------- |
| 0.0.13: Current Currants | 1.20.1    | 47.4.10 |
...
1. Download the latest instance: [Cousins.zip](https://github.com/finnolin/cousins/releases/latest/download/Cousins.zip)

2. Open Prism Launcher → Add Instance → Import from zip

3. Select the downloaded `Cousins.zip`
